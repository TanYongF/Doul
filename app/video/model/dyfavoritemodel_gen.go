...
type (
	dyFavoriteModel interface {
		...
		FindOneByUserIdVideoId(ctx context.Context, userId int64, videoId int64) (*DyFavorite, error)
...
func (m *defaultDyFavoriteModel) FindOneByUserIdVideoId(ctx context.Context, userId int64, videoId int64) (*DyFavorite, error) {
