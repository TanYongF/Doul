...
) ENGINE=InnoDB AUTO_INCREMENT=325 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `dy_relation` (
                               ...
                               `follower_id` bigint NOT NULL DEFAULT '0' COMMENT '博主ID',
                               `following_id` bigint NOT NULL DEFAULT '0' COMMENT '粉丝ID',
                               `is_del` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除',
                               PRIMARY KEY (`relation_id`) USING BTREE,
                               KEY `dy_relation_follower_id_IDX` (`follower_id`) USING BTREE,
                               KEY `dy_relation_following_id_IDX` (`following_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='用来描述用户和粉丝之间的关系';
